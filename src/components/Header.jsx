            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span className="self-center text-2xl text-gray-800 font-semibold whitespace-nowrap dark:text-white">Cinemate</span>
                    </Link>
                    ...
                    <div id="navbar-search" className={`${hidden ? 'hidden' : " "} items-center justify-between w-full md:flex md:w-auto md:order-1`}>
                        ...
                        <ul className="flex flex-col p-4 md:p-0 mt-4 text-base font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
